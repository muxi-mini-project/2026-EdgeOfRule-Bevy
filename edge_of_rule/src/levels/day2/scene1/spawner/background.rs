...
#[derive(Component)]
pub struct Day2Scene1Background;
...
pub fn spawn(mut commands: Commands, assets: Res<LevelsImageAssets>) {
    commands.spawn((
        ...
        Day2Scene1Background,
    ));
    commands.spawn((
        SpriteBundle {
            texture: assets.day2_scene1_background.clone(),
...
pub fn despawn(mut commands: Commands, backgrounds: Query<Entity, With<Day2Scene1Background>>) {
