...
#[derive(Component)]
pub struct Day2Scene3Background;
...
pub fn spawn(mut commands: Commands, assets: Res<LevelsImageAssets>) {
    commands.spawn((
        ...
        Day2Scene3Background,
    ));
    commands.spawn((
        SpriteBundle {
            texture: assets.day2_scene3_background.clone(),
...
pub fn despawn(mut commands: Commands, backgrounds: Query<Entity, With<Day2Scene3Background>>) {
