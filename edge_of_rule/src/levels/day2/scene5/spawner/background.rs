...
#[derive(Component)]
pub struct Day2Scene5Background;
...
pub fn spawn(mut commands: Commands, assets: Res<LevelsImageAssets>) {
    commands.spawn((
        ...
        Day2Scene5Background,
    ));
    commands.spawn((
        SpriteBundle {
            texture: assets.day2_scene5_background.clone(),
...
pub fn despawn(mut commands: Commands, backgrounds: Query<Entity, With<Day2Scene5Background>>) {
